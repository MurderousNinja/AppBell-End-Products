...
public class SetupLoginActivity extends AppCompatActivity {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (businessIDEditText.getText().toString().equals("1111") && businessPasswordEditText.getText().toString().equals("11111111")) {
                    Toast.makeText(SetupLoginActivity.this, "Login Successful", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(SetupLoginActivity.this, SetupMainActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(SetupLoginActivity.this, "UserID, BusinessID, or Business Password is incorrect", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
